...
const About = () => {
  return (
    <div className="flex flex-1 items-center justify-center lg:px-[124px] lg:gap-[112px] md:px-14 md:gap-14 px-6 gap-6 flex-wrap">
      <Image
        className="lg:w-[390px] lg:h-[810px] "
        alt="background"
        src={Phone}
      />
      <div className="w-full h-full lg:pt-[110px] lg:max-w-[690px] sm:min-w-[450px]">
