      ...
      <div className="max-w-desktop h-full m-auto flex justify-between items-center px-4 md:px-0">
        ...
        <div>
          <p
            ...
            className="md:text-[32px] text-xl text-center cursor-pointer md:leading-8 leading-6 border-logo"
          >
        ...
        <div className="hidden md:flex gap-8">
          {items.map((item) => (
            <p
              ...
              className="cursor-pointer hover:scale-110 transition-all text-stroke hover:text-gray-100"
              key={item}
            >
              {item}
            </p>
        ...
        >
          {items.map((item) => (
            <p
              ...
              className="cursor-pointer text-stroke"
              key={item}
            >
              {item}
            </p>
